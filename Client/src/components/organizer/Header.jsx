    ...
    <header className="h-14 sm:h-16 bg-white/90 backdrop-blur-2xl border-b border-white/60 flex items-center justify-between px-4 sm:px-6 lg:px-8 shadow-lg relative z-[100]">
      ...
      <div className="flex-1 flex justify-center max-w-xs sm:max-w-md md:max-w-xl mx-auto">
        <div className="relative group w-full">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors" size={16} strokeWidth={2.5} />
          <input
            type="text"
            placeholder="Search..."
      ...
      <div className="flex items-center gap-2 sm:gap-3 ml-3 sm:ml-4">
        ...
        <div className="relative">
          ...
          >
            <Bell size={18} className="text-gray-600 group-hover:text-blue-600 transition-colors sm:w-5 sm:h-5" strokeWidth={2.5} />
            ...
            <div className="absolute right-0 top-full mt-2 w-72 sm:w-80 bg-white/95 backdrop-blur-2xl border border-white/60 rounded-2xl shadow-2xl z-[9999] overflow-hidden">
              ...
              <div className="max-h-64 overflow-y-auto">
                {notifications.map((notif) => (
                  ...
                  >
                    <p className="text-xs sm:text-sm text-gray-800 font-bold group-hover:text-blue-700 transition-colors">{notif.message}</p>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 sm:gap-3 p-1.5 sm:p-2 hover:bg-gradient-to-br hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all duration-300 hover:scale-105 group"
          >
            <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
              <User size={16} className="text-white sm:w-[18px] sm:h-[18px]" strokeWidth={2.5} />
            </div>
            ...
            <ChevronDown size={14} className="text-gray-400 group-hover:text-blue-600 transition-colors hidden sm:block sm:w-4 sm:h-4" strokeWidth={2.5} />
          </button>
          ...
          {showProfileMenu && (
            <div className="absolute right-0 top-full mt-2 w-44 sm:w-48 bg-white/95 backdrop-blur-2xl border border-white/60 rounded-2xl shadow-2xl z-[9999] py-2 overflow-hidden">
              <a href="#" className="block px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 font-bold transition-all">
                Profile Settings
              </a>
              <a href="#" className="block px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 font-bold transition-all">
                Help & Support
              ...
              <a href="#" className="block px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-red-600 hover:bg-red-50 font-black transition-all">
                Logout
              </a>
            </div>
          )}
