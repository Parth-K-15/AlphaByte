...
const Header = ({ mobileOpen, setMobileOpen }) => {
  ...
  const notifications = [
    ...
    {
      id: 2,
      message: "Event update published",
      time: "1 hour ago",
      unread: false,
    },
  ];
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 top-full mt-2 w-72 sm:w-80 bg-white/95 dark:bg-[#1a1a2a]/95 backdrop-blur-2xl border border-white/60 dark:border-white/10 rounded-2xl shadow-2xl dark:shadow-black/40 z-[9999] overflow-hidden">
              <div className="p-3 sm:p-4 border-b border-gray-100 dark:border-white/5 bg-gradient-to-r from-gray-50 to-white dark:from-white/5 dark:to-transparent">
              ...
              <div className="max-h-64 overflow-y-auto">
                {notifications.map((notif) => (
                  <div
                    key={notif.id}
                    className={`p-3 sm:p-4 border-b border-gray-50 dark:border-white/5 hover:bg-blue-50/50 dark:hover:bg-white/5 cursor-pointer transition-all group ${
                      notif.unread ? "bg-blue-50/30 dark:bg-lime/5" : ""
                    }`}
                  >
                    <p className="text-xs sm:text-sm text-gray-800 dark:text-zinc-200 font-semibold group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                      {notif.message}
                    </p>
              ...
              <div className="p-2 sm:p-3 text-center border-t border-gray-50 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]">
                <button className="text-xs sm:text-sm text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white font-semibold hover:underline transition-all">
        ...
        <div className="relative">
            ...
            <div className="flex items-center gap-3">
              <div
                className="w-8 h-8 sm:w-9 sm:h-9
                   bg-gradient-to-br from-gray-800 to-gray-900 dark:from-lime dark:to-lime/80
              ...
              >
                {profileData.avatar ? (
                  ...
                  <User
                    size={16}
                    className="text-lime dark:text-dark sm:w-[18px] sm:h-[18px]"
                    strokeWidth={2}
                  />
                )}
              </div>
              ...
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-gray-600 dark:text-zinc-500 font-medium">
                  {profileData.role}
                </p>
              </div>
            </div>
          ...
          {showProfileMenu && (
            <div className="absolute right-0 top-full mt-2 w-44 sm:w-48 bg-white/95 dark:bg-[#1a1a2a]/95 backdrop-blur-2xl border border-white/60 dark:border-white/10 rounded-2xl shadow-2xl dark:shadow-black/40 z-[9999] py-2 overflow-hidden">
              <a
                href="#"
                className="block px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-gray-700 dark:text-zinc-300 hover:bg-blue-50/50 dark:hover:bg-white/5 font-medium transition-all"
              >
                Profile Settings
              </a>
              <a
              ...
              <a
                href="#"
                className="block px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 font-semibold transition-all"
              >
                Logout
              </a>
            </div>
