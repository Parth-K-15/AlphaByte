...
import { ArrowLeft, Eye, EyeOff, Mail, Lock, User, Phone, Building, BookOpen, GraduationCap, Users } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join as a participant to explore events</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  value={formData.year}
                  onChange={handleChange}
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none cursor-pointer bg-white"
                >
