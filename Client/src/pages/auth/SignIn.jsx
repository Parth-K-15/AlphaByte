...
import { Eye, EyeOff, Calendar, Users, ArrowLeft } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2">
          ...
          <div className="p-8 lg:p-12 relative">
            ...
            <div className="mt-8 flex items-center justify-between text-sm">
              <Link to="/signup" className="text-gray-900 hover:text-indigo-600 transition font-medium">
          ...
          {/* Right Side - Image */}
          <div className="hidden lg:block relative bg-gradient-to-br from-blue-100 via-indigo-50 to-purple-50 p-12">
            <div className="h-full flex items-center justify-center relative">
              ...
              <div className="absolute top-12 left-8 bg-white rounded-2xl shadow-xl p-4 max-w-xs">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="text-xs text-gray-500">Upcoming Event</div>
                    <div className="text-sm font-bold text-gray-900">Tech Conference 2024</div>
                  </div>
                </div>
              </div>

              <div className="absolute bottom-12 left-12 bg-white rounded-2xl shadow-xl p-4 max-w-xs">
                <div className="text-sm font-bold text-gray-900 mb-3">Team Collaboration</div>
                <div className="text-xs text-gray-500 mb-3">Join your team workspace</div>
                <div className="flex -space-x-2">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-8 h-8 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full border-2 border-white"></div>
                  ))}
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="w-64 h-64 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl">
                  <Users className="w-32 h-32 text-white/90" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Manage Everything</h3>
                <p className="text-gray-600">All your events in one place</p>
              </div>
            </div>
          </div>
        </div>
