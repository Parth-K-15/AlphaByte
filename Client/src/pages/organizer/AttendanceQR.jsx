  ...
  return (
    <div className="space-y-8 max-w-full overflow-x-hidden">
      ...
      <div>
        ...
        {events.length > 0 ? (
          <select
            ...
            className="mt-4 px-4 py-2 text-sm border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#B9FF66] shadow-sm hover:border-[#B9FF66] transition-all font-bold text-gray-900 bg-white w-full md:w-auto"
          >
            {events.map((event) => (
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        <div className="group relative bg-white rounded-2xl p-4 md:p-6 border border-gray-100 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="p-2 md:p-3 bg-[#191A23] rounded-xl shadow-lg">
              <Users size={18} className="text-[#B9FF66] md:w-6 md:h-6" strokeWidth={2.5} />
            </div>
          </div>
        </div>
        ...
        <div className="group relative bg-white rounded-2xl p-4 md:p-6 border border-gray-100 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between">
            <div className="mb-3 md:mb-0">
              ...
              <p className="text-2xl md:text-4xl font-black text-[#191A23] mt-1 md:mt-2">{liveCount.present || 0}</p>
            </div>
            <div className="p-2 md:p-3 bg-[#B9FF66] rounded-xl shadow-lg">
              <CheckCircle size={18} className="text-[#191A23] md:w-6 md:h-6" strokeWidth={2.5} />
            </div>
          </div>
        </div>
        ...
        <div className="group relative bg-white rounded-2xl p-4 md:p-6 border border-gray-100 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between">
            <div className="mb-3 md:mb-0">
              ...
              <p className="text-2xl md:text-4xl font-black text-red-600 mt-1 md:mt-2">{(liveCount.total || 0) - (liveCount.present || 0)}</p>
            </div>
        ...
        <div className="group relative bg-white rounded-2xl p-4 md:p-6 border border-gray-100 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between">
            <div className="mb-3 md:mb-0">
              ...
              <p className="text-2xl md:text-4xl font-black text-[#191A23] mt-1 md:mt-2">
                {liveCount.total > 0 ? Math.round((liveCount.present / liveCount.total) * 100) : 0}%
              </p>
            </div>
            <div className="p-2 md:p-3 bg-[#191A23] rounded-xl shadow-lg">
              <Activity size={18} className="text-[#B9FF66] md:w-6 md:h-6" strokeWidth={2.5} />
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col items-center">
              {qrData ? (
                <div className="text-center">
                  ...
                  <p className="text-gray-700 font-bold mt-6 mb-2">Session ID: <span className="font-black text-[#191A23]">{qrData.sessionId}</span></p>
                ...
                <div className="text-center">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-gray-600 font-bold mt-4">
                      Static QR code for <span className="text-[#191A23] font-black">{events.find(e => e._id === selectedEvent)?.title}</span>
                    </p>
                  </div>
          ...
          {activeTab === 'logs' && (
            <div>
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                ...
                <button className="group flex items-center gap-2 px-6 py-3 border border-gray-200 rounded-xl hover:bg-[#B9FF66]/10 hover:border-[#B9FF66] transition-all font-bold text-gray-700">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {participants
                        ...
                        .map((participant, index) => {
                          ...
                          return (
                              <tr key={participant._id} className="hover:bg-[#B9FF66]/5 transition-all">
