      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-[#191A23] rounded-2xl flex items-center justify-center shadow-xl">
            <MessageSquare size={24} className="text-[#B9FF66]" strokeWidth={2.5} />
          </div>
          <div>
        ...
        <div className="flex gap-4 items-center">
          <button
            ...
            className="group px-4 py-2 border border-gray-300 rounded-xl hover:bg-[#B9FF66]/10 hover:border-[#B9FF66] transition-all font-bold text-gray-700"
        ...
        <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/60 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-black text-[#191A23] mt-2">
        ...
        <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/60 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-black text-[#191A23] mt-2">{displayTemplates.length}</p>
            </div>
            <div className="p-4 bg-[#191A23]/10 rounded-2xl shadow-lg group-hover:scale-110 transition-transform">
              <FileText size={24} className="text-[#191A23]" strokeWidth={2.5} />
            </div>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-6 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#B9FF66] focus:border-[#B9FF66] bg-white/80 backdrop-blur-sm font-bold text-gray-900"
                    >
                        ...
                        <button
                          ...
                          className={`group flex items-center gap-3 p-4 rounded-2xl border-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 ${
                            emailData.recipientFilter === filter.value
                              ? 'border-[#191A23] bg-[#B9FF66]/10 text-[#191A23] shadow-lg'
                              : 'border-gray-200 text-gray-600 hover:border-[#B9FF66]'
                          }`}
                        >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#B9FF66] focus:border-[#B9FF66] bg-white/80 backdrop-blur-sm font-semibold text-gray-900 placeholder-gray-500"
                    />
                  </div>
...
{{eventDate}} - Event date"
                      className="w-full px-6 py-4 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#B9FF66] focus:border-[#B9FF66] bg-white/80 backdrop-blur-sm font-mono text-sm resize-none"
                    />
                  </div>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#B9FF66]"
                    />
                  </div>
          ...
          <div className="divide-y divide-gray-100 max-h-[500px] overflow-y-auto">
            {displayHistory.length === 0 ? (
              ...
              displayHistory.map((item) => (
                <div key={item._id} className="p-5 hover:bg-[#B9FF66]/5 transition-all cursor-pointer">
